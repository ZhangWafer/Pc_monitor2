...
$sqlBinaryPathx86 = Join-Path $packagePath "nativeBinaries\x86\SqlServerSpatial130.dll"
$sqlBinaryPathx64 = Join-Path $packagePath "nativeBinaries\x64\SqlServerSpatial130.dll"
...
$sqlLinkx86 = $folderx86.ProjectItems | where Name -eq "SqlServerSpatial130.dll"
if (!$sqlLinkx86)
{
...
$sqlLinkx64 = $folderx64.ProjectItems | where Name -eq "SqlServerSpatial130.dll"
if (!$sqlLinkx64)
{
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUeJ15lp1p36VB4k/kIljX+MYo
# DaKgghWCMIIEwzCCA6ugAwIBAgITMwAAADPlJ4ajDkoqgAAAAAAAMzANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFDly
# uUftHpGO3DfKs6gSuTGftrvFMHgGCisGAQQBgjcCAQwxajBooDSAMgBNAGkAYwBy
...
# KoZIhvcNAQEBBQAEggEAVx/R4ApQopaJEXOFCv3QyUA0lILcVv+hadxRme62xM18
# PurxYnwr5TEQkeA1soJiHOs/88t7Ywt7zQW3KwuRVhEcOzaeID3GabDDvgTrEvVi
# HQ0WhfD3Mi5wOTiPNtkos2VR7ObYCfEr/zNWh67/Be0zUVDnuI9/K/2sqkINyRol
# BZuqaI6RBmFWXCXhXaLKQhfCFIRovqL6o8BHF4OCobsY458ogeuh+wj3ASa1ojec
# 1IMTbfMsGaQSUtTelv1sLlApYHwJrmOPEAMW7vSiada/b7NjutTS+VZskcAHUFSu
# oPL10BT+CMUA/Q9Ljlz6DErgtEeSjcT3MGcQ8QnIJ6GCAigwggIkBgkqhkiG9w0B
...
# 5SeGow5KKoAAAAAAADMwCQYFKw4DAhoFAKBdMBgGCSqGSIb3DQEJAzELBgkqhkiG
# 9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE0MDIxMzE2NDkyMFowIwYJKoZIhvcNAQkE
# MRYEFLbehh6RVINckEW9i9DTBRMirlDwMA0GCSqGSIb3DQEBBQUABIIBAAhAQEVQ
# YtD9yCfN/a9cg6LSffkD9GgNl/uGNbqddDHHnK4PrYIbELjbWp99du53qP8JNClR
# QjWvtOz2nz87UmI0hFv9e8bWgUzlt+oXKSr1wRGJiCrdrem1w5QhweORoYyfjdVK
# bSarJbGoMEHleqphrShAsnerFopD6hrOUSuTpUwNS2TKJwSRCn3hqdslmDAu0J/K
# fyOn+X25hFDnko9qfYKZ/ZNt+5C6YcYzA2nRdCaAyD0oRVCQuxk8+a6i1mYnw0cN
# V+GLzKCfIWv/53t23FRhMdz0Dl2bJC839EbIFixgBOTRiHKE0m3CW5k7dG3HUjwJ
# mYhA2N6vQskSjjw=
